...
<head>
  ...
  <title>Dream Me - Fashion for Juniors</title>
...
for ($i=0; $i <count($notification_array) ; $i++) {  ?>
							...
							<?php if($_SESSION['customer_id']!=''){
								echo '<li><a href="'.Site_URL.'account-setting.php" data-tooltip="tooltip" data-placement="bottom" title="Profile"><i class="fa fa-user" aria-hidden="true"></i></a></li>';
