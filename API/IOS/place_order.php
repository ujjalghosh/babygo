...
//$search_array = $obj['add_to_wishlist'];
     

//$response["data"] = $obj;

//if (isset($_POST['add_to_wishlist']))  {
 if (array_key_exists('place_order', $obj)) {
        ...
        <table width="600" cellpadding="1" cellspacing="0" style="margin:0 auto;border:1px solid #000;border-collapse: collapse;">
          ...
          <tr style="font-size:14px;border-top: 1px solid #000;">
            ...
            <td colspan="3" valign="top">
                <br/>'.$order_array[0]["customer_name"].'<br/>'.$order_mstr[0]["shipping_address"].'<br/>GSTIN No.:'.$order_array[0]["vat_no"].'<br/>PAN :'.$order_array[0]["pan_no"].'
