...
//$order_query = $db->query("select distinct product_id from " . $db->tbl_pre . "orders_tbl where customer_id='" . $customer_id . "' and order_status='Cart'", PDO::FETCH_BOTH);

if (isset($_POST['customer_id']) && isset($_POST['product_id']))  {
  $customer_id=$_POST['customer_id'];
$product_id=$_POST['product_id'];
  $order_delete = $db->update('orders_tbl', array("order_status"=>'Cart'),"product_id='" . $product_id . "' and customer_id='" . $customer_id . "'");
