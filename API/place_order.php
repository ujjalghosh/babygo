...
$order_confirm = $db->update('product_details_tbl', $name_value, "product_details_id='" . $product_details_id . "'   ");
}
        ...
        <table width="600" cellpadding="1" cellspacing="0" style="margin:0 auto;border:1px solid #000;border-collapse: collapse;">
          ...
          <tr style="font-size:14px;border-top: 1px solid #000;">
            ...
            <td colspan="3" valign="top">
                <br/>'.$order_array[0]["Company_name"].'<br/>'.$order_mstr[0]["billing_address"].'<br/>GSTIN No.:'.$order_array[0]["vat_no"].'<br/>PAN :'.$order_array[0]["pan_no"].'
          ...
          <tr style="font-size:14px;border-bottom: 1px solid #000;">
            <td align="left">SL</td>
            <td align="center" width="220"  style="border-left: 1px solid #000;">Description of Goods</td>
            <td align="center"  style="border-left: 1px solid #000;">Style No.</td>
            <td align="center"  style="border-left: 1px solid #000;">Size</td>
            <td align="center"  style="border-left: 1px solid #000;">Colour</td>
            <td align="center"  style="border-left: 1px solid #000;">Sets</td>
            <td align="center"  style="border-left: 1px solid #000;">Pcs</td>
            <td align="center" width="65"  style="border-left: 1px solid #000;">Amount</td>
          </tr>';
  $i=0;$set=0;$piece=0;
...
$message.='<tr style="border-bottom: 1px solid #000;">
          ...
          <tr>
            <td colspan="8" style="font-size:13px;">
                Terms :<br/>1) Taxes: Applicable.<br/>2) Defects/Shortages if any should be reported within three days from the receipt of goods.<br/>3) Interest @18 % will be charged after due date.<br/>4) All disputes are Subject to Howrah Jurisdiction.<br/>5) Our Banker : Axis Bank Ltd, Corporate Banking Branch, A/c. 916030037170546, IFSC: UTIB0001164.<br/>6) This is a computer generated copy hence signature is not required.
            </td>
          </tr>
        </table>
    </body>
