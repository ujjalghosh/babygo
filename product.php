...
$product_array = $Product->product_display($db->tbl_pre . "product_tbl", array(), "WHERE category_id=".$category_id." and  ".$sql_group." order by ".$order_by." ");

//$product_totalnum = $Product->product_display($db->tbl_pre . "product_tbl", array(), "WHERE category_id=".$category_id." and  ".$sql_group." ");

} else {
    $product_array = $Product->product_display($db->tbl_pre . "product_tbl", array(), "WHERE category_id=".$category_id." and  ".$sql_group." ");
}
}
							...
							<ul class="filter-list">
								...
								<li>
									...
									<ul class="dropdown-menu">									
										...
										<li><a href="<?php echo Site_URL.'product.php?category_id='.$category_id; ?>"> Sort by</a></li>

										<li><a href="<?php echo Site_URL.'product.php?sort_by=Popularity&category_id='.$category_id; ?>">Popularity</a></li>

										<li><a href="<?php echo Site_URL.'product.php?sort_by=New&category_id='.$category_id; ?>">New</a></li>

										<li><a href="<?php echo Site_URL.'product.php?sort_by=Hot Selling&category_id='.$category_id; ?>">Hot Selling</a></li>
								...
								<li class="purple-drop">
									...
									<ul class="dropdown-menu">
										...
										<li><a href="<?php echo Site_URL.'product.php?refine_by='.$refine_by_array[$i]["product_group_id"].'&category_id='.$category_id; ?>"><?php echo $refine_by_array[$i]["product_group_name"]; ?></a></li>
