...
$aColumns = array('location_id', 'location_name', 'location_status');
$sIndexColumn = "location_id";
$sTable = $db->tbl_pre . "location_tbl";
$sWhere = "WHERE location_id<>0";
//print_r($_GET);
//// Pagination //
$sLimit = "";
...
// Generate Sql Query //
$aRow = $location->location_display($sTable, $aColumns, $sWhere, $sLimit, $sOrder);
...
$sQuery = $db->query("SELECT * FROM " . $db->tbl_pre . "location_tbl");
