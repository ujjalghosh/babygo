	...
	jQuery.alerts = {
		...
		_show: function(title, msg, value, type, callback) {
			...
			switch( type ) {
				...
				break;
				case 'prompt':
				jQuery("#popup_message").append('<br /><textarea rows="10" cols="50" id="popup_prompt"></textarea>').after('<div id="popup_panel"><input type="button" value="' + jQuery.alerts.okButton + '" id="popup_ok" /> <input type="button" value="' + jQuery.alerts.cancelButton + '" id="popup_cancel" /></div>');
